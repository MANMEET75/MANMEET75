...
void setup() {
  ...
  strs[0][0] = "Hey there!";
  strs[0][1] = "My name is Manmeet Singh.";

  strs[1][0] = "I'm a Currently Pursing BTECH (IT)";
  strs[1][1] = "at GTBIT at Rajouri Garden in New Delhi.";

  strs[2][0] = "I've been teaching myself how to code for 6 years!";
  strs[2][1] = "I am fluent in C, C++, Python, JavaScript, and HTML & CSS.";

  strs[3][0] = "I've created apps, websites, and art using what I've learned.";
  strs[3][1] = "Have a look at My Portfolio😊";

  strs[5][0] = "i am Innovative, Creative, Fast Learner, Python Lover ❤ , AI Enthusiast";
  strs[5][1] = "Contact Me:email: samanmeet85@gmail.com";
}
